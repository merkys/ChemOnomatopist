...
my @cases = (
    ...
    { smiles => 'CS(=O)(S)=O', iupac => 'methanesulfonothioic S-acid', AUTHOR => 1 },
    { smiles => 'CS(=O)([SeH])=O', iupac => 'methanesulfonoselenoic Se-acid', AUTHOR => 1 },
    ...
    { smiles => 'CS(=N)(=S)[SeH]', iupac => 'methanesulfonimidoselenothioic Se-acid' },

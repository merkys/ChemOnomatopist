...
my @cases = (
    ...
    { smiles => 'C1(=CC=CC=C1)C(=O)O[Se]', iupac => 'benzenecarbo(selenoperoxoic) OSe-acid', AUTHOR => 1 },
    ...
    { smiles => 'C1(=CC=CC=C1)C(=S)O[Se]', iupac => 'benzenecarbo(selenoperoxo)thioic OSe-acid', AUTHOR => 1 },
    { smiles => 'C1(=CC=CC=C1)C(=S)SS', iupac => 'benzenecarbo(dithioperoxo)thioic acid', AUTHOR => 1 },
    { smiles => 'C1(=CC=CC=C1)C(=[Se])[Se][Se]', iupac => 'benzenecarbo(diselenoperoxo)selenoic acid', AUTHOR => 1 },
    { smiles => 'C1(=CC=CC=C1)C(=[Te])[Te][Te]', iupac => 'benzenecarbo(ditelluroperoxo)telluroic acid', AUTHOR => 1 },

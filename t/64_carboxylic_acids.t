...
my @cases = (
    ...
    { smiles => 'C1(=CC=CC=C1)C(OO)=[Se]', iupac => 'benzenecarboperoxoselenoic acid' },
    { smiles => '', iupac => 'benzenecarbo(thioperoxoic) SO-acid', AUTHOR => 1 },
    { smiles => '', iupac => 'benzenecarbo(thioperoxoic) OS-acid', AUTHOR => 1 },

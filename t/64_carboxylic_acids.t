...
my @cases = (
    ...
    { smiles => 'C1(=CC=CC=C1)C(=[Se])[Se][SeH]', iupac => 'benzenecarbo(diselenoperoxo)selenoic acid', AUTHOR => 1 },
    { smiles => 'C1(=CC=CC=C1)C(=[Te])[Te][TeH]', iupac => 'benzenecarbo(ditelluroperoxo)telluroic acid', AUTHOR => 1 },

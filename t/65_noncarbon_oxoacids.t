...
my @cases = (
    ...
    { smiles => 'N(O)O', iupac => 'azonous acid' },
    { smiles => '[N+](O)(O)(O)[O-]', iupac => 'nitroric acid' },
    { smiles => 'N(O)(O)O', iupac => 'azorous acid' },
    ...
    { smiles => 'Br(=O)O', iupac => 'bromous acid' },
    { smiles => 'Cl(=O)(=O)O', iupac => 'chloric acid' },
    { smiles => 'Cl(=O)O', iupac => 'chlorous acid' },
    ...
    { smiles => 'I(=O)O', iupac => 'iodous acid' },
    { smiles => '[N+](=O)(O)[O-]', iupac => 'nitric acid' },
    { smiles => 'N(=O)O', iupac => 'nitrous acid' },

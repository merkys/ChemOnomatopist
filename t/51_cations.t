...
my @cases = (
    ...
    { smiles => '[CH2+]CC', iupac => 'propylium', AUTHOR => 1 },
    ...
    { smiles => 'C[C+2]C', iupac => 'propane-2,2-bis(ylium)', AUTHOR => 1 },
    { smiles => '[CH+]1[CH+]C=C1', iupac => 'cyclobut-3-ene-1,2-bis(ylium)', AUTHOR => 1 },
    { smiles => '[CH+]1C=CC=C1', iupac => 'cyclopenta-2,4-dien-1-ylium', AUTHOR => 1 },
    { smiles => 'O=C1[N+]C(CC1)=O', iupac => '2,5-dioxopyrrolidin-1-ylium', AUTHOR => 1 },
);

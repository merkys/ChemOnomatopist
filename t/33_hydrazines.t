...
my @cases = (
    ...
    { smiles => 'CN(N)C', iupac => '1,1-dimethylhydrazine', AUTHOR => 1 },
    { smiles => 'C1(=CC=CC=C1)NN', iupac => 'phenylhydrazine', AUTHOR => 1 },
    ...
    { smiles => 'C(CC)=NN', iupac => 'propylidenehydrazine', AUTHOR => 1 },

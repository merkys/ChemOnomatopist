package ChemOnomatopist::Comparable::Array::Isotope::By::AtomicNumber;
...
sub cmp
{
    ...
    my %A_freq = array_frequencies map { $_->atomic_number } @$A;
    my %B_freq = array_frequencies map { $_->atomic_number } @$B;
